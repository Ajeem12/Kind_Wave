        ...
        <AnimatePresence>
            <>
                ...
                <motion.div
                    ...
                    className="fixed bottom-0 left-0 w-full bg-white rounded-t-xl shadow-xl z-50 p-6 md:max-w-md md:left-1/2 md:-translate-x-1/2"
                ...
                >
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4 mb-6 ">
                        <input
                            ...
                            required
                            className="border-[0.5px] rounded-[10px] px-4 py-3 focus:outline-none "
                        />
                        {role === "organization" && (
                            <select
                                value={categories}
                                ...
                                required
                                className="border-[0.5px] rounded-[10px] px-4 py-3 focus:outline-none f"
                            >

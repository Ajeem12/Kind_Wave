...
//                     className={`w-full bg-[#06acff] text-white py-2 px-4 rounded-md transition ${mutation.isLoading ? 'opacity-70 cursor-not-allowed' : ''}`}
//                 >
        ...
        <div className="max-w-md mx-auto p-6 ">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                    type="submit"
                    disabled={mutation.isLoading}
                    className={`w-full flex justify-center items-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#06acff] focus:outline-none ${mutation.isLoading ? 'opacity-70 cursor-not-allowed' : ''
                        }`}
                >
                    {mutation.isLoading ? (
                        <>
